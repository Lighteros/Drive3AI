...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [895],
  {
    ...
    57437: function (e, r, o) {
      e.exports = o(30622);
    },
    57042: function (e, r, o) {
      o.d(r, {
        W: function () {
          return t;
        },
      ...
      let M = (function (e) {
        ...
        return {
          ...
          classGroups: {
            ...
            grow: [{ grow: K() }],
            shrink: [{ shrink: K() }],
            order: [{ order: ["first", "last", "none", x, w] }],
            "grid-cols": [{ "grid-cols": [P] }],
            "col-start-end": [{ col: ["auto", { span: ["full", x, w] }, w] }],
            "col-start": [{ "col-start": U() }],
            "col-end": [{ "col-end": U() }],
            "grid-rows": [{ "grid-rows": [P] }],
            "row-start-end": [{ row: ["auto", { span: [x, w] }, w] }],
            ...
            contrast: [{ contrast: [c] }],
            "drop-shadow": [{ "drop-shadow": ["", "none", k, w] }],
